...
/**
 * Class RuleWithMethodsCounterAndTwoErrorTask
 * @package QSchool\Sandbox\Tests\Rules\DummyRules
 */
class RuleWithMethodsCounterAndTwoErrorTask extends BaseRule
{
    /**
     * @var int
     */
    ...
    {
        $this->assertTrue(false, 'Custom Error Text 1', $this->pointsToError1);
    }

    /**
     * @throws \QSchool\Sandbox\Validator\ValidationException
     */
    public function test_error_2()
    {
        $this->assertTrue(false, 'Custom Error Text 2', $this->pointsToError2);
    }
}
